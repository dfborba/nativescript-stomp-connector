...
declare class StompClientLib extends NSObject {
	...
	public openSocketWithURLRequest(request: NSURLRequest, delegate: StompClientLibDelegate, connectionHeaders: [String: string]);
	public isConnected(): boolean;
	public disconnect();
	public sendMessageToDestination(message: string, destination: string);
	public sendMessageToDestinationWithHeaders(message: string, destination: string, headers: [String: string]);
	public sendMessageToDestinationWithHeadersWithReceipt(message: string, destination: string, headers: [String: string], receipt: string);
